  ...
  switch (normalized) {
    ...
    case "vip":
      return {
        ...
        soft: "border-amber-200 bg-amber-50/80 text-amber-900",
        tint: "border-amber-200 bg-amber-50",
        nav: "border-b border-amber-100 bg-amber-50/60",
        navActive: "border-b-2 border-amber-500 text-amber-900",
        navInactive: "text-amber-700/80",
        text: "text-amber-700",
      };

...
export default function KatsuyouPage() {
    ...
    }, [loading, rows, selectedPos, selectedQType]);
        ...
        <main className="min-h-screen bg-white px-4 py-6 text-gray-900">
            <div className="mx-auto max-w-3xl">
                ...
                {!isDailyLimitReached && questions.length > 0 ? (
                                                ...
                                                {q.qtype === "jp2kr" ? (
                                                    <div className="mt-3">
                                                        <button
                                                            ...
                                                            onClick={() =>
                                                                speakJapanese(
                                                                    q.qtype === "jp2kr" ? q.prompt : q.correct_text,
                                                                    `answer-${idx}`
                                                                )
                                                            }
                    ...
                    <div
                        className={`mt-6 rounded-2xl border p-5 ${isDailyLimitReached ? "border-red-200 bg-red-50" : "border-gray-300 bg-white"
                            }`}
                    >
